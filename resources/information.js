...
function traducir() {
    ...
    document.getElementById('icon3').innerHTML = selectmenu.talarma;
    document.getElementById('icon4').innerHTML = selectmenu.tinformacion;
    document.getElementById('icon5').innerHTML = selectmenu.tacs_legionela;
    document.getElementById('icon6').innerHTML = selectmenu.tfrio_pasivo;
    document.getElementById('icon7').innerHTML = selectmenu.tcalefaccion;
    document.getElementById('icon8').innerHTML = selectmenu.tpiscina;
    document.getElementById('wifi').innerHTML = nuevas_paginas.modo_conexion;
    document.getElementById('back').innerHTML = nuevas_paginas.atras;
    ...
    document.getElementById("icon4").style.color = '#85b724';
